...
class LeftClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path.lineTo(size.width * .1, size.height * .01);
    path.lineTo(0, size.height * .03);
    path.lineTo(size.width * .1, size.height * .05);
    path.lineTo(0, size.height * .07);
    path.lineTo(size.width * .1, size.height * .09);
    path.lineTo(0, size.height * .11);
    path.lineTo(size.width * .1, size.height * .13);
    path.lineTo(0, size.height * .15);
    path.lineTo(size.width * .1, size.height * .17);
    path.lineTo(0, size.height * .19);
    path.lineTo(size.width * .1, size.height * .21);
    path.lineTo(0, size.height * .23);
    path.lineTo(size.width * .1, size.height * .25);
    path.lineTo(0, size.height * .27);
    path.lineTo(size.width * .1, size.height * .29);
    path.lineTo(0, size.height * .31);
    path.lineTo(size.width * .1, size.height * .33);
    path.lineTo(0, size.height * .35);
    path.lineTo(size.width * .1, size.height * .37);
    path.lineTo(0, size.height * .39);
    path.lineTo(size.width * .1, size.height * .41);
    path.lineTo(0, size.height * .43);
    path.lineTo(size.width * .1, size.height * .45);
    path.lineTo(0, size.height * .47);
    path.lineTo(size.width * .1, size.height * .49);
    path.lineTo(0, size.height * .51);
    path.lineTo(size.width * .1, size.height * .53);
    path.lineTo(0, size.height * .55);
    path.lineTo(size.width * .1, size.height * .57);
    path.lineTo(0, size.height * .59);
    path.lineTo(size.width * .1, size.height * .61);
    path.lineTo(0, size.height * .63);
    path.lineTo(size.width * .1, size.height * .65);
    path.lineTo(0, size.height * .67);
    path.lineTo(size.width * .1, size.height * .69);
    path.lineTo(0, size.height * .71);
    path.lineTo(size.width * .1, size.height * .73);
    path.lineTo(0, size.height * .75);
    path.lineTo(size.width * .1, size.height * .77);
    path.lineTo(0, size.height * .79);
    path.lineTo(size.width * .1, size.height * .81);
    path.lineTo(0, size.height * .83);
    path.lineTo(size.width * .1, size.height * .85);
    path.lineTo(0, size.height * .87);
    path.lineTo(size.width * .1, size.height * .89);
    path.lineTo(0, size.height * .91);
    path.lineTo(size.width * .1, size.height * .93);
    path.lineTo(0, size.height * .95);
    path.lineTo(size.width * .1, size.height * .97);
